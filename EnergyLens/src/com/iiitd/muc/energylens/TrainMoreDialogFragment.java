...
import com.iiitd.muc.energylens.LocationDialogFragment.LocationDialogListener;
...
public class TrainMoreDialogFragment extends DialogFragment {
	 ...
	 public void onAttach(Activity activity) {
	        ...
	        try {
	            // Instantiate the TrainMoreDialogListener so we can send events to the host
	            mListener = (TrainMoreDialogListener) activity;
	        } catch (ClassCastException e) {
	            // The activity doesn't implement the interface, throw exception
	            throw new ClassCastException(activity.toString()
	                    + " must implement TrainMoreDialogListener");
	        }
	    }
