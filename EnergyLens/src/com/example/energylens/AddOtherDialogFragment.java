...
public class AddOtherDialogFragment extends DialogFragment {
	    ...
	    // Add action buttons
	           .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
	               ...
	               public void onClick(DialogInterface dialog, int id) {
	            	   ...
	            	   Log.v("ELSERVICES","Other string: "+otherString);
	                   mListener.onOtherSelected(otherString);
	               }
	           })
	           .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
	               public void onClick(DialogInterface dialog, int id) {
	                   AddOtherDialogFragment.this.getDialog().cancel();
	               }
	           });      
